      ...
      <div className="shell-container">
        <section className="page-heading">
          <div>
            ...
            <h1>Oportunidades de fornecimento</h1>
            <p>
              Compare demandas reais do protótipo e encontre o melhor encaixe para sua produção.
            </p>
          </div>
          <div className="mock-label">
            <i className="bi bi-database" aria-hidden="true" /> Dados demonstrativos
          </div>
        </section>
        ...
        <div className="opportunities-layout">
          ...
          <aside
            ...
            ref={filtersRef}
            className={`filters-panel ${mobileFiltersOpen ? 'is-open' : ''}`}
          ...
          >
            <div className="filters-title">
              <div>
                <span className="eyebrow">Refine sua busca</span>
                <h2>Filtros</h2>
              </div>
              <button
                ref={filtersCloseRef}
            ...
            <div className="filter-group">
              ...
              >
                <option>Todas</option>
                {[...new Set(initialDemands.map((item) => item.category))].map((value) => (
            ...
            <RangeStepper
              ...
              formatValue={(currentDistance) =>
                currentDistance === MAX_DISTANCE ? 'Qualquer' : `${currentDistance} km`
              }
              getValueText={(currentDistance) =>
                currentDistance === MAX_DISTANCE
                  ? 'Qualquer distância'
                  : `Até ${currentDistance} quilômetros`
              }
              decreaseLabel="Diminuir distância máxima em 10 quilômetros"
              increaseLabel="Aumentar distância máxima em 10 quilômetros"
            />

            <button type="button" className="btn btn-ghost w-100" onClick={clearFilters}>
              Limpar filtros
            </button>
            ...
            <div className="filter-help">
              ...
              <p>
                <strong>Dica</strong>Atualize sua disponibilidade na página inicial para receber sugestões mais precisas.
              </p>
            </div>
          </aside>
          ...
          <section className="results-panel">
            <div className="results-toolbar">
              <div role="status" aria-live="polite" aria-atomic="true">
                <strong>
                  ...
                  {filteredDemands.length === 1 ? 'oportunidade' : 'oportunidades'}
                </strong>
                <span>
                  {search
                    ? ` para “${search}”`
                    : ' compatíveis com o perfil demonstrativo'}
                </span>
              </div>
              ...
              <div className="results-controls">
                <button
                  type="button"
                  className="btn btn-secondary mobile-filter-button"
                ...
                <label htmlFor="sort-opportunities">Ordenar</label>
                <select
            ...
            {filteredDemands.length ? (
              ...
              <div className="empty-state">
                ...
                <p>Tente ampliar a distância ou remover algum filtro.</p>
