    ...
    <aside className="col-md-3 d-none d-md-block">
      <div className="card">
        <div className="card-body p-3">
          ...
          <div className="d-flex justify-content-around align-items-center py-2 mt-3 border-top border-bottom border-suave text-center">
            <div>
          ...
          <nav className="d-flex flex-column gap-2 mt-3 pt-3 border-top border-suave">
            ...
            <a href="#culturas" className="dashboard-nav-item" onClick={(e) => e.preventDefault()}>
              <i className="bi bi-tree"></i>
              <span>Minhas Culturas</span>
            </a>
            <NavLink to="/explorar" className="dashboard-nav-item">
              <i className="bi bi-file-earmark-text"></i>
              <span>Minhas Demandas</span>
            </NavLink>
            <a href="#mensagens" className="dashboard-nav-item" onClick={(e) => e.preventDefault()}>
              <i className="bi bi-chat-left-text"></i>
              <span>Mensagens</span>
            </a>
            <a href="#config" className="dashboard-nav-item" onClick={(e) => e.preventDefault()}>
