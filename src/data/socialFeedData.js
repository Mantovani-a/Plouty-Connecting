...
export const socialFeedPosts = [
  {
    ...
    author: {
      ...
      type: 'institution',
      avatar: '/images/social/avatars/escola-sementes-vale.jpg',
      verified: true
    },
    ...
    postImage: {
      src: '/images/social/posts/post-festa-milho.jpg',
    ...
    repostCount: 3,
    comments: [
      { id: 'escola-milho-1', initials: 'JC', name: 'João Carlos', avatar: '/images/social/avatars/joao-carlos.jpg', text: 'Foi uma alegria participar. Obrigado pela confiança no nosso trabalho!', time: 'há 35 min' },
      { id: 'escola-milho-2', initials: 'MR', name: 'Marina Ribeiro', avatar: '/images/social/avatars/marina-ribeiro.jpg', text: 'As crianças voltaram para casa contando tudo sobre a origem dos alimentos.', time: 'há 18 min' }
    ]
  },
  {
    ...
    postImage: {
      src: '/images/social/posts/post-entrega-hospital.jpg',
    ...
    repostCount: 1,
    comments: [
      { id: 'joao-entrega-1', initials: 'HR', name: 'Hospital Regional', avatar: '/images/social/avatars/hospital-regional-guarapari.jpg', text: 'Entrega recebida no horário e com ótima qualidade. Parabéns à equipe!', time: 'ontem' },
      { id: 'joao-entrega-2', initials: 'AS', name: 'Ana Souza', avatar: '/images/social/avatars/ana-souza.jpg', text: 'Muito bom ver produção local chegando às instituições da região.', time: 'ontem' }
    ]
  },
  {
    ...
    postImage: {
      src: '/images/social/posts/post-parceria-local.jpg',
    ...
    repostCount: 5,
    comments: [
      { id: 'hospital-parceria-1', initials: 'CR', name: 'Cooperativa Raízes', avatar: '/images/social/avatars/cooperativa-raizes.jpg', text: 'Parcerias assim dão previsibilidade para quem produz e qualidade para quem recebe.', time: 'há 2 dias' },
      { id: 'hospital-parceria-2', initials: 'LM', name: 'Lucas Martins', avatar: '/images/social/avatars/lucas-martins.jpg', text: 'Um resultado importante para toda a comunidade.', time: 'há 2 dias' }
    ]
  }
];
