export const socialTopics = [
  { id: 'alimentacao-escolar', label: 'Alimentação escolar', recentPosts: 18 },
  { id: 'safra-milho', label: 'Safra do milho', recentPosts: 12 },
  { id: 'logistica-entregas', label: 'Logística e entregas', recentPosts: 9 }
];

export const socialSuggestions = {
  producer: [
    {
      id: 'escola-sol-nascente',
      initials: 'ES',
